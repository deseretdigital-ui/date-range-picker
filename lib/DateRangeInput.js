...
var DateRangeInput = _react2['default'].createClass({
  ...
  propTypes: {
    ...
    showDefaultRanges: _react2['default'].PropTypes.bool,
    defaultDisplayValue: _react2['default'].PropTypes.string
  },
  ...
  getDisplayValue: function getDisplayValue() {
    var displayValue = this.props.defaultDisplayValue;
    if (this.state.value) {
  ...
  renderDefaultRanges: function renderDefaultRanges() {
    ...
    if (this.props.showDefaultRanges) {
      defaultRanges = _react2['default'].createElement(
        'ul',
