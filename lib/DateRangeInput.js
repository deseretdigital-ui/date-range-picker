...
var momentRangeProp = function momentRangeProp(props, propName, componentName) {
  ...
  if (propValue !== null) {
    var message = 'Invalid prop `' + propName + '` supplied to' + ' `' + componentName + '`. Must be of type `DateRange`.' + ' Validation failed.';
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.hasValidDate = function () {
    ...
    if (_this3.state.value) {
      try {
        _this3.state.value.start.format('DD MMM YYYY');
        _this3.state.value.end.format('DD MMM YYYY');
        isValid = true;
      } catch (error) {
        // Do nothing
      }
  ...
  this.isValueCustomRange = function () {
    ...
    _this3.props.ranges.forEach(function (range) {
      if (_this3.state.value && _this3.state.value.isSame(range.value)) {
        isCustom = false;
      }
    });
      ...
      ranges = _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            {
              type: 'button',
              onMouseEnter: _this3.handleHighlightRange.bind(null, { start: null, end: null }),
