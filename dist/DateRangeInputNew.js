...
var defaultRanges = [{
  ...
  label: 'Last 30 Days',
  value: _momentRange["default"].range((0, _momentRange["default"])().startOf('day').subtract(29, 'days'), (0, _momentRange["default"])().startOf('day'))
}, {
  label: 'This Month',
...
var useMediaQuery = function useMediaQuery(dispatch, singleCalendarBreakpoint) {
  var _useState = (0, _react.useState)(null),
      _useState2 = _slicedToArray(_useState, 2),
      mediaQuery = _useState2[0],
      setMediaQuery = _useState2[1];

  (0, _react.useEffect)(function () {
    var breakpoint = singleCalendarBreakpoint;
    var media = 'only screen and (max-width: ' + breakpoint + 'px)';
    var newMediaQuery = window.matchMedia(media);

    var observeMediaQuery = function observeMediaQuery() {
      var matches = mediaQuery ? mediaQuery.matches : newMediaQuery.matches;
...
__signature__(useMediaQuery, "useState{[mediaQuery, setMediaQuery](null)}\nuseEffect{}");

var DateRangeInputNew = function DateRangeInputNew(props) {
  ...
  var _useReducer = (0, _react.useReducer)(_reducer["default"], initialState),
      ...
      dispatch = _useReducer2[1]; // useMediaQuery(setNumCalendars, props.singleCalendarBreakpoint);
...
__signature__(DateRangeInputNew, "useRef{dateRangeInputWrapperRef}\nuseReducer{[state, dispatch](initialState)}\nuseCallback{closeDropdown}\nuseEffect{}");
...
var _default = (0, _reactHotLoader.hot)(module)(DateRangeInputNew);
...
(function () {
  ...
  reactHotLoader.register(defaultRanges, "defaultRanges", "/Users/nchristensen/repos/date-range-picker/src/DateRangeInputNew.jsx");
  reactHotLoader.register(useMediaQuery, "useMediaQuery", "/Users/nchristensen/repos/date-range-picker/src/DateRangeInputNew.jsx");
  reactHotLoader.register(DateRangeInputNew, "DateRangeInputNew", "/Users/nchristensen/repos/date-range-picker/src/DateRangeInputNew.jsx");
  reactHotLoader.register(_default, "default", "/Users/nchristensen/repos/date-range-picker/src/DateRangeInputNew.jsx");
})();
